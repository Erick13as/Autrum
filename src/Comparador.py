...
class AudioComparator:
    ...
    def load_atm_file(self):
        ...
        if file_path:
            with open(file_path, 'rb') as af:
                ...
                self.original_audio = np.frombuffer(af.read(audio_len * 2), dtype=np.int16)
    ...
    def record_audio_loop(self):
        if self.is_recording:
            ...
            self.root.after(1, self.record_audio_loop)
    ...
    def compare_audio(self):
        ...
        try:
            ...
            audio_to_compare, _ = sf.read(self.audio_to_compare_path)
            ...
            def compute_power_spectra(signal_magnitude):
                ...
                signal_power /= np.sum(signal_power)
                return signal_power
